...
class COrderedList {
	public :
		...
		typedef typename std::list<Type>::const_iterator DATA_LIST_ITERATOR;
...
{
	DATA_LIST_ITERATOR iDataThis = m_List.begin();
	DATA_LIST_ITERATOR iDataSub = listSub.m_List.begin();
	DATA_LIST_ITERATOR iDataTemp;
